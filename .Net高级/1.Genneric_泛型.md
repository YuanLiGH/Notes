...
### 六、协变
> #### <font color='red'>协变</font>：接口<font color='red'>*IEnumerable*</font> 的 <font color="red">*类型参数*</font> 用 <font color='red'>*out*</font> 修饰后， <font color="red">*类型参数*</font> 只能做为 <font color='red'>*返回值*</font> ，不能作为 <font color='red'>*入参数*</font>。  
> **<font color="red">效果</font>**：可以让 **接口类型的 <font color="red">*左边*</font>** 使用 **<font color="red">*父类*</font>** ，**实体化的 <font color="red">*右边*</font>** 使用 **<font color="red">*子类*</font>**。
> ```CSharp   
...
### 七、逆变
> #### <font color='red'>逆变</font>：接口<font color='red'>*IEnumerable*</font> 的 <font color="red">*类型参数*</font> 用 <font color='red'>*in*</font> 修饰后， <font color="red">*类型参数*</font> 只能做为 <font color='red'>*入参数*</font> ，不能作为 <font color='red'>*返回值*</font>。  
