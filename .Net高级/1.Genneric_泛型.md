...
### 六、协变
> #### <font color='red'>协变</font>：接口<font color='red'>*IEnumerable 、IEnumerato 、IQueryable 、IGrouping 、IReadOnlyList 、IReadOnlyCollection *</font> 的 <font color="red">*类型参数*</font> 用 <font color='red'>*out*</font> 修饰后， <font color="red">*类型参数*</font> 只能做为 <font color='red'>*返回值*</font> ，不能作为 <font color='red'>*入参数*</font>。  
